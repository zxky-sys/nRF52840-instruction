...
ENV QMK_HOME /qmk
RUN git clone https://github.com/zxky-sys/nRF52840-instruction.git && cp -r /nRF52840-instruction/keyboards/ /qmk/keyboards/ && rm -rf /nRF52840-instruction
RUN cp /qmk/keyboards/candy_ble/uf2conv.py /qmk